                                ...
                                <?php foreach ($order_array as $item) : ?>
                                    <?php if ($item['u_id'] == $userLogin['userID'] && $item["o_quantity"] > 0 && $item["o_status"] == 1): 
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td style="text-align: center;" id="price_<?php echo $item['p_id']; ?>" class="column-3 darkModetxt">$ <?php echo $item["p_price"]; ?></td>
                                            <td style="text-align: center;" id="quantity_<?php echo $item['p_id']; ?>" class="column-4 darkModetxt"><?php echo $item["o_quantity"]; ?></td>
