...
<head>
	<title>Omacha Shop | Privacy Policy</title>
	<meta charset="UTF-8">
...
word-break: break-word !important;
	...
	<!-- Footer -->
	<footer style="background-color: #fff8f8ff; margin-left: -140px; margin-right: -140px; margin-bottom: -40px;" class="bg3 p-t-100 p-b-25 noselect">
