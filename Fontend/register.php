...
<head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="/Fontend/css/auth-form.css">
    <!-- link icon -->
            ...
            <h1 class="auth-form-heading">Sign up</h1>
                <form action="" class="auth-form">
                    <div class="auth-input-container">
                        <input type="text" class="auth-input-field" placeholder="Enter Username" id="name"/>
                        <label for="name" class="auth-input-label">Username</label>
                        <i class="input-icon fa fa-user"></i>
                    </div>
                    <div class="auth-input-container">
                        <input type="text" class="auth-input-field" placeholder="Enter Email" id="name"/>
                        <label for="name" class="auth-input-label">Email</label>
                        <i class="input-icon fa fa-envelope"></i>
                    </div>

                    <div class="auth-input-container">
                        <input type="password" class="auth-input-field" placeholder="Enter Password" id="password"/>
