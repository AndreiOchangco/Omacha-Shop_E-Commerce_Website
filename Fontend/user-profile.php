                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6 col-lg-3 p-b-50">
                            ...
                            <ul>
                                <li><a href="#" class="stext-107 cl7 hov-cl1 trans-04">Toys</a></li>
                                <li><a href="#" class="stext-107 cl7 hov-cl1 trans-04">Baby Gifts</a></li>
                                <li><a href="#" class="stext-107 cl7 hov-cl1 trans-04">Educational</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-6 col-lg-3 p-b-50">
                            <h4 class="stext-301 cl0 p-b-30">Help</h4>
                            <ul>
                                <li><a href="#" class="stext-107 cl7 hov-cl1 trans-04">Track Order</a></li>
                                <li><a href="#" class="stext-107 cl7 hov-cl1 trans-04">Returns</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-6 col-lg-3 p-b-50">
                            <h4 class="stext-301 cl0 p-b-30">Contact</h4>
                            <p class="stext-107 cl7 size-201">
                                Have questions? Contact us at:<br>omachashopofficial@gmail.com
                            </p>
                        </div>
                    </div>
                    <div class="p-t-40">
                        <p class="stext-107 cl6 txt-center">
                            &copy; <script>document.write(new Date().getFullYear());</script> Omacha Shop. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
