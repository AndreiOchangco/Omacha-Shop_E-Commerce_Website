...
<head>
  ...
  <title>Omacha Shop | Add Discount</title>
        ...
        <form method="POST" enctype="multipart/form-data">
          <div class="content">
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <input class="form-control" name="d_name" id="name" type="text" placeholder="Name your Discount">
            </div>

            <div class="form-group text-gray-700 dark:text-gray-200">
              <label for="price">Amount</label>
              <input class="form-control" id="name" name="d_amount" type="text" placeholder="Add Amount">
            </div>

            <div class="form-group text-gray-700 dark:text-gray-200">
              <label for="type">Description</label>
              <select id="type" class="form-control text-black" name="d_description">
                <option>Select Discount Percentage</option>
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <input class="form-control text-black" id="name" name="d_start_date" type="date">
            </div>

            <div class="form-group text-gray-700 dark:text-gray-200">
              <label for="price">End Date</label>
              <input class="form-control text-black" id="name" name="d_end_date" type="date">
            </div>
