...
<head>
  ...
  <title>Omacha Shop | Add Product</title>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet" />
  <link rel="stylesheet" href="./assets/css/tailwind.output.css" />
  <link rel="stylesheet" href="../../Fontend/css/main.css" />
  <link rel="stylesheet" href="../../Fontend/css/universal.css" />
  <!-- link icon -->
        ...
        <ul>
          ...
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
              ...
              <span class="ml-4">Manage Message</span>
            </a>
          </li>
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
              ...
              <span class="ml-4">Manage Buttons</span>
            </a>
          </li>
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
              ...
              <span class="ml-4"> Manage Modals</span>
            </a>
          </li>
          <li class="relative px-6 py-3">
            <button
    ...
    <div class="flex flex-col flex-1 w-full">
      ...
      <main class="h-full pb-16 overflow-y-auto">
        ...
        <form action="addProduct.php" method="POST" enctype="multipart/form-data">
          <div class="content">
            <div class="form-group text-gray-700 dark:text-black">
              <label for="name" class="dark:text-gray-200">Product Name</label>
              <input class="form-control" name="p_name" id="name" type="text" placeholder="Name of the Product">
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <select id="type" class="form-control text-black" name="p_age">
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <select id="type" class="form-control text-black" name="p_provider">
                <option>Select Provider</option>
                <option>ACE Hardware</option>
                <option>Toy Kingdom</option>
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <select id="type" class="form-control text-black" name="p_type">
                <option>Select a Type of Material</option>
