...
<head>
  ...
  <title>Omacha Shop | Edit Product</title>
        ...
        <form method="POST" enctype="multipart/form-data" action="updateProduct.php">
          <div class="content">
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <input class="form-control text-black" name="p_name" id="name" type="text" placeholder="Name of the Product"
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <input class="form-control text-black" id="name" name="p_price" type="text" placeholder="Price"
            ...
            <div class="form-group text-gray-700 dark:text-gray-200">
              ...
              <textarea class="form-control text-black" id="description" name="p_description" rows="4"
