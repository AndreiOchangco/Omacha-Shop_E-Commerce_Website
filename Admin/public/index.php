<?php
 ...
 //   header('Location: ../Fontend/register.php');
 //   die();
 //}
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Omacha Shop | Dashboard</title>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Andrei Ochangco</p>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Louis Servito</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Website Designer
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Mark Rivera</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Ardy Aquino</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Sales Analyst
                          </p>
                        </div>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Vince Alvendia</p>
                          <p class="text-xs text-gray-600 dark:text-gray-400">
                            Sales Analyst
                          </p>
                        </div>
          ...
          <div class="grid gap-6 mb-8 md:grid-cols-2">
            <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
              ...
              <div class="flex justify-center mt-4 space-x-3 text-sm text-gray-600 dark:text-gray-400">
                ...
                <div class="flex items-center">
                  <span class="inline-block w-3 h-3 mr-1 unsought-legend-color rounded-full"></span>
                  <span>Unsought</span>
                </div>
                <div class="flex items-center">
                  <span class="inline-block w-3 h-3 mr-1 digital-legend-color rounded-full"></span>
                  <span>Digital</span>
                </div>
              </div>
            </div>
